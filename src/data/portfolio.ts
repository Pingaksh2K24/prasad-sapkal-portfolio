...
export const personalInfo = {
  ...
  bio: 'Passionate senior frontend / full stack developer with expertise in modern web technologies and a love for creating innovative digital solutions.',
...
export const projects: Project[] = [
  {
    ...
    description:
      'A modern and responsive school/college website template with clean design and user-friendly interface.',
    technologies: [
      'MERN',
      'Next.js',
      'HTML5',
    ...
    liveUrl:
      'https://siddhivinayak-technolabs-education-website-template.vercel.app',
    imageUrl:
  ...
  },
  {
    ...
    description:
      'A comprehensive school ERP platform with admin panel for managing students, teachers, and academic operations.',
    technologies: [
      'React',
      'Node.js',
      'Express',
  ...
  },
  {
    ...
    description:
      'A comprehensive billing and inventory management dashboard for retail businesses with sales tracking and reporting.',
    technologies: [
      'React',
      'Chart.js',
      'Node.js',
...
export const experience: Experience[] = [
  {
    ...
    description: [
      ' Guided and mentored team members in development tasks and technical decision-making',
      ' Contributed to architecture design and development of React Native applications',
      ' Supported and enhanced React.js project architecture, ensuring scalable and maintainable solutions',
    ],
    technologies: [
      'React',
      'React Native',
...
export const skills: Skill[] = [
  ...
  {
    category: 'Database',
    items: ['PostgreSQL', 'My SQL', 'MongoDB'],
  },
  {
