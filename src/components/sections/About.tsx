...
export default function About() {
  return (
    <section id="about" className="py-24 bg-gradient-to-br from-white dark:from-gray-900 via-blue-50 dark:via-gray-800 to-indigo-50 dark:to-gray-900 relative overflow-hidden">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div className="mb-10">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 dark:from-white to-blue-800 dark:to-blue-400 bg-clip-text text-transparent">My Journey</h3>
              </div>
              
              <div className="space-y-4 mb-8">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  With over 5 years of professional experience in frontend development, I have successfully 
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  Throughout my career, I&apos;ve progressed from System Engineer to Sr. Software Developer, 
            ...
            <div>
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 dark:from-white to-blue-800 dark:to-blue-400 bg-clip-text text-transparent">Skills & Technologies</h3>
              </div>
